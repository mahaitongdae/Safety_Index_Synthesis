...
def main():
    ...
    parser.add_argument('--logdir', nargs='*',default=['/home/mahaitong/PycharmProjects/safety-starter-agents/data/2021-08-30_ppo_dual_ascent_sis_Safexp-CustomGoal3-v0'])
    parser.add_argument('--legend', '-l', nargs='*')
    parser.add_argument('--xaxis', '-x', default='TotalEnvInteracts')
    parser.add_argument('--value', '-y', default='LossSisParas', nargs='*')
